; Patched for offline installation
...
vcredist2017_exe=vc_redist.x86.exe
vcredist2017_exe_x64=vc_redist.x64.exe
...
begin
	...
	if (not IsIA64()) then begin
		if (not msiproductupgrade(GetString(vcredist2017_upgradecode, vcredist2017_upgradecode_x64, ''), minVersion)) then
			AddProduct(CustomMessage('vcredist2017_exe' + GetArchitectureString()),
				'/passive /norestart',
